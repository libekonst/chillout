...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"requestJSON\", function() { return requestJSON; });\n/* harmony import */ var _populateDOM__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./populateDOM */ \"./src/js/populateDOM.js\");\n\r\n\r\n//@ts-check\r\nfunction requestJSON() {\r\n    const requestURL = 'https://kostaslib.github.io/chillout/src/radios.json';\r\n    const request = new XMLHttpRequest();\r\n    request.open('GET', requestURL);\r\n    request.responseType = 'json';\r\n    request.send();\r\n    \r\n    request.onload = () => {\r\n        const radioData = request.response;\r\n        console.log(radioData);\r\n        for (let radio of radioData.music) {\r\n            console.log(radio);\r\n            new _populateDOM__WEBPACK_IMPORTED_MODULE_0__[\"RadioItem\"](radio.name, radio.id, radio.img, 'music');\r\n        }\r\n        for (const radio of radioData.news) {\r\n            console.log(radio);\r\n            new _populateDOM__WEBPACK_IMPORTED_MODULE_0__[\"RadioItem\"](radio.name, radio.id, radio.img, 'news');\r\n        }\r\n    };\r\n}\n\n//# sourceURL=webpack:///./src/js/requestJSON.js?");
